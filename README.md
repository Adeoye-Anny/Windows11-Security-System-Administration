...
### Steps Taken
* Navigated to Settings → Windows Update.
...
### Testing Process
* Verified Microsoft Defender was enabled and up to date.
* Downloaded the EICAR test string from a trusted source.
* Attempted to save the file to the system.
...
* Basic troubleshooting using Event Viewer
* Endpoint security validation with Microsoft Defender

### Conclusion
This lab demonstrates my practical understanding of Windows 11 administration and endpoint security. The ability to manage users, maintain system updates, troubleshoot issues, and validate antivirus protection reflects real-world IT Support and Help Desk responsibilities in a corporate environment.
